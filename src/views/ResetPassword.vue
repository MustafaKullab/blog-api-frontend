...
// Function to handle with reset password
const hanldeResetPassword = async () => {
  ...
  if (data.success) {
    ...
    codeErrorMessage.value = "Code is not correct";
  } else if (data.message === "User is not found!") {
    passwordErrorMessage.value = "User is not found!";
  } else {
    confPasswordErrorMessage.value = "Passwords is not equal";
  }
};
</script>
