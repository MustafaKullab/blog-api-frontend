        ...
        >
          ...
          <form @submit.prevent="handleLogin">
            <div class="mb-3">
              ...
              />
              <div id="email" class="errorCode invalid-feedback">{{ emailMessage }}</div>
            </div>
            <div class="position-relative mb-3">
              ...
              />
              <div id="password" class="errorCode invalid-feedback">{{ passwordMessage }}</div>
              <div
...
// Function to handle with login user
...
.container-boxes {
  height: 520px;
  .text-side {
    background: linear-gradient(to right, #002e5d, #2774ae);
  }
  .form-side {
    input {
      transition: 0.3s;
